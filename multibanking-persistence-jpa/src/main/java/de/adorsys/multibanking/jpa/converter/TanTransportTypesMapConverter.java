...
@Slf4j
public class TanTransportTypesMapConverter implements AttributeConverter<Map<String, List<TanTransportTypeJpaEntity>>
        , String> {
    ...
    public Map<String, List<TanTransportTypeJpaEntity>> convertToEntityAttribute(String tanTransportTypesJson) {
        TypeReference<HashMap<String, List<TanTransportTypeJpaEntity>>> typeRef
                = new TypeReference<HashMap<String, List<TanTransportTypeJpaEntity>>>() {
        };
