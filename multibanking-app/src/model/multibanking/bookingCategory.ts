...
export interface BookingCategory {
    ...
    homepage?: string;
    hotline?: string;
    interval?: BookingCategory.IntervalEnum;
    logo?: string;
    mainCategory?: string;
...
export namespace BookingCategory {
    export type IntervalEnum = 'WEEKLY' | 'MONTHLY' | 'TWO_MONTHLY' | 'QUARTERLY' | 'HALF_YEARLY' | 'YEARLY' | 'INVALID';
