...
public class BankConnectionOwner {
  ...
  **/
   ...
   * @return lastName
  **/
  @ApiModelProperty(example = "Mustermann", value = "Last name")
   ...
   * @return salutation
  **/
  @ApiModelProperty(example = "Herr", value = "Salutation")
   ...
   * @return title
  **/
  @ApiModelProperty(example = "Dr.", value = "Title")
   ...
   * @return email
  **/
  @ApiModelProperty(example = "email@localhost.de", value = "Email")
   ...
   * @return dateOfBirth
  **/
  @ApiModelProperty(example = "1980-01-01", value = "Date of birth (in format 'YYYY-MM-DD')")
   ...
   * @return postCode
  **/
  @ApiModelProperty(example = "80000", value = "Post code")
   ...
   * @return country
  **/
  @ApiModelProperty(example = "Deutschland", value = "Country")
   ...
   * @return city
  **/
  @ApiModelProperty(example = "München", value = "City")
   ...
   * @return street
  **/
  @ApiModelProperty(example = "Musterstraße", value = "Street")
   ...
   * @return houseNumber
  **/
  @ApiModelProperty(example = "99", value = "House number")
