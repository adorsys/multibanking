...
public class Transaction {
  ...
  **/
  @ApiModelProperty(value = "Counterpart Bank name")
  ...
  **/
  @ApiModelProperty(value = "The mandate reference of the counterpart")
  ...
  **/
  @ApiModelProperty(value = "The customer reference of the counterpart")
  ...
  **/
  @ApiModelProperty(value = "The creditor ID of the counterpart")
   ...
   * @return type
  **/
  @ApiModelProperty(value = "Transaction type, according to the bank. If set, this will contain a German term that you can display to the user. Some examples of common values are: \"Lastschrift\", \"Auslands&uuml;berweisung\", \"Geb&uuml;hren\", \"Zinsen\". The maximum possible length of this field is 255 characters.")
   ...
   * @return typeCodeZka
  **/
  @ApiModelProperty(value = "ZKA business transaction code which relates to the transaction's type. Possible values range from 1 through 999. If no information about the ZKA type code is available, then this field will be null.")
  ...
  **/
  @ApiModelProperty(value = "SWIFT transaction type code. If no information about the SWIFT code is available, then this field will be null.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, parentId, accountId, valueDate, bankBookingDate, finapiBookingDate, amount, purpose, counterpartName, counterpartAccountNumber, counterpartIban, counterpartBlz, counterpartBic, counterpartBankName, counterpartMandateReference, counterpartCustomerReference, counterpartCreditorId, type, typeCodeZka, typeCodeSwift, primanota, category, labels, isPotentialDuplicate, isAdjustingEntry, isNew, importDate, children, paypalData);
  }
