...
public class ErrorDetails {
  ...
  **/
   ...
   * @return code
  **/
  @ApiModelProperty(example = "UNEXPECTED_ERROR", value = "Error code. See the documentation of the individual services for details about what values may be returned.")
   ...
   * @return type
  **/
  @ApiModelProperty(example = "TECHNICAL", value = "Error type. BUSINESS errors depict German error messages for the user, e.g. from a bank server. TECHNICAL errors depict internal errors.")
