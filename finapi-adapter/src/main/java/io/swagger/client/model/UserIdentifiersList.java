...
public class UserIdentifiersList {
   ...
   * @return deletedUsers
  **/
  @ApiModelProperty(example = "[\"first_user\",\"second_user\"]", required = true, value = "List of identifiers of deleted users (in ascending order)")
  ...
  **/
  @ApiModelProperty(example = "[\"third_user\",\"fourth_user\"]", required = true, value = "List of identifiers of not deleted users (in ascending order)")
