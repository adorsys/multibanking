...
public class InlineResponse2004 {
  ...
  public InlineResponse2004 successMessage(String successMessage) {
  ...
  **/
  ...
  public InlineResponse2004 warnMessage(String warnMessage) {
  ...
  **/
  ...
  public InlineResponse2004 challengeMessage(String challengeMessage) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Message from the bank server containing information or instructions on how to retrieve the TAN that is needed to execute the requested money transfer. This message should be presented to the user. Note that some bank servers may limit the message to just the most crucial information, e.g. the message may contain just a single number that depicts the target TAN number on a user's TAN list. You may want to parse the challenge message for such cases and extend it with more detailed information before showing it to the user.")
  ...
  public InlineResponse2004 answerFieldLabel(String answerFieldLabel) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "Suggestion from the bank server on how you can label your input field where the user must enter his TAN. A typical value that many bank servers give is 'TAN-Nummer'.")
  ...
  public InlineResponse2004 tanListNumber(String tanListNumber) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "In case that the bank server has instructed the user to look up a TAN from a TAN list, this field may contain the identification number of the TAN list. However in most cases, this field is only set (i.e. not null) when the user has multiple active TAN lists.")
  ...
  public InlineResponse2004 opticalData(String opticalData) {
   ...
   * @return opticalData
  **/
  @ApiModelProperty(example = "null", value = "In case that the bank server has instructed the user to scan a flicker code, then this field will contain the raw data for the flicker animation as a BASE-64 string. Otherwise, this field will be not set (i.e. null). For more information on how to process the flicker code data, please address the <a href=\"https://finapi.zendesk.com\">finAPI Developer Portal</a>.")
  ...
  public InlineResponse2004 photoTanMimeType(String photoTanMimeType) {
  ...
  **/
  @ApiModelProperty(example = "null", value = "In case that the 'photoTanData' field is set (i.e. not null), this field contains the MIME type to use for interpreting the photo data (e.g.: 'image/png')")
  ...
  public InlineResponse2004 photoTanData(String photoTanData) {
   ...
   * @return photoTanData
  **/
  @ApiModelProperty(example = "null", value = "In case that the bank server has instructed the user to scan a photo (or more generally speaking, any kind of QR-code-like data), then this field will contain the raw data of the photo as a BASE-64 string. Otherwise, this field will be not set (i.e. null). For more information on how to process the photo data, please address the <a href=\"https://finapi.zendesk.com\">finAPI Developer Portal</a>.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.successMessage, inlineResponse2004.successMessage) &&
        Objects.equals(this.warnMessage, inlineResponse2004.warnMessage) &&
        Objects.equals(this.challengeMessage, inlineResponse2004.challengeMessage) &&
        Objects.equals(this.answerFieldLabel, inlineResponse2004.answerFieldLabel) &&
        Objects.equals(this.tanListNumber, inlineResponse2004.tanListNumber) &&
        Objects.equals(this.opticalData, inlineResponse2004.opticalData) &&
        Objects.equals(this.photoTanMimeType, inlineResponse2004.photoTanMimeType) &&
        Objects.equals(this.photoTanData, inlineResponse2004.photoTanData);
  }
