...
public class Body20 {
  ...
  public Body20 userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  **/
  ...
  public Body20 password(String password) {
   ...
   * @return password
  **/
  @ApiModelProperty(example = "null", required = true, value = "User's new password. Minimum length is 6, and maximum length is 36.")
  ...
  public Body20 passwordChangeToken(String passwordChangeToken) {
  ...
  **/
  @ApiModelProperty(example = "null", required = true, value = "Decrypted password change token (the token that you received from the /users/requestPasswordChange service, decrypted with your data decryption key)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.userId, body20.userId) &&
        Objects.equals(this.password, body20.password) &&
        Objects.equals(this.passwordChangeToken, body20.passwordChangeToken);
  }
