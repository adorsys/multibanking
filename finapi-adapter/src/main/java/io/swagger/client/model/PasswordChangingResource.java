...
public class PasswordChangingResource {
  ...
  **/
   ...
   * @return userEmail
  **/
  @ApiModelProperty(example = "email@localhost.de", value = "User's email, encrypted. Decrypt with your data decryption key. If the user has no email set, then this field will be null.")
  ...
  **/
  @ApiModelProperty(example = "EnCRyPTEDPassWordCHAnGEToKen==", required = true, value = "Encrypted password change token. Decrypt this token with your data decryption key, and pass the decrypted token to the /users/executePasswordChange service in order to set a new password for the user.")
