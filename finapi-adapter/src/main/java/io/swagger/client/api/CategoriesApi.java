...
public class CategoriesApi {
    ...
    private com.squareup.okhttp.Call createCategoryCall(Body6 body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createCategoryValidateBeforeCall(Body6 body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @return InlineResponse2008Categories
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse2008Categories createCategory(Body6 body) throws ApiException {
        ApiResponse<InlineResponse2008Categories> resp = createCategoryWithHttpInfo(body);
        return resp.getData();
    }
     ...
     * Create a new custom category for the authorized user. Must pass the user&#39;s access_token.
     * @param body Parameters of the new category (optional)
     * @return ApiResponse&lt;InlineResponse2008Categories&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
     ...
     */
    public com.squareup.okhttp.Call createCategoryAsync(Body6 body, final ApiCallback<InlineResponse2008Categories> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call deleteAllCategoriesCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public InlineResponse2001 deleteAllCategories() throws ApiException {
        ApiResponse<InlineResponse2001> resp = deleteAllCategoriesWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteAllCategoriesAsync(final ApiCallback<InlineResponse2001> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call deleteCategoryCall(Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/api/v1/categories/{id}".replaceAll("\\{format\\}","json")
    ...
    private com.squareup.okhttp.Call getAndSearchAllCategoriesCall(List<Long> ids, String search, Boolean isCustom, Integer page, Integer perPage, List<String> order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (isCustom != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "isCustom", isCustom));
        if (page != null)
    ...
    public InlineResponse2008 getAndSearchAllCategories(List<Long> ids, String search, Boolean isCustom, Integer page, Integer perPage, List<String> order) throws ApiException {
        ApiResponse<InlineResponse2008> resp = getAndSearchAllCategoriesWithHttpInfo(ids, search, isCustom, page, perPage, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAndSearchAllCategoriesAsync(List<Long> ids, String search, Boolean isCustom, Integer page, Integer perPage, List<String> order, final ApiCallback<InlineResponse2008> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call getCashFlowsCall(String search, String counterpart, List<Long> accountIds, String minBankBookingDate, String maxBankBookingDate, String minFinapiBookingDate, String maxFinapiBookingDate, BigDecimal minAmount, BigDecimal maxAmount, String direction, List<Long> labelIds, List<Long> categoryIds, Boolean isNew, String minImportDate, String maxImportDate, Boolean includeSubCashFlows, List<String> order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        localVarQueryParams.addAll(apiClient.parameterToPairs("", "includeSubCashFlows", includeSubCashFlows));
        if (order != null)
        localVarQueryParams.addAll(apiClient.parameterToPairs("multi", "order", order));
    ...
    public InlineResponse2009 getCashFlows(String search, String counterpart, List<Long> accountIds, String minBankBookingDate, String maxBankBookingDate, String minFinapiBookingDate, String maxFinapiBookingDate, BigDecimal minAmount, BigDecimal maxAmount, String direction, List<Long> labelIds, List<Long> categoryIds, Boolean isNew, String minImportDate, String maxImportDate, Boolean includeSubCashFlows, List<String> order) throws ApiException {
        ApiResponse<InlineResponse2009> resp = getCashFlowsWithHttpInfo(search, counterpart, accountIds, minBankBookingDate, maxBankBookingDate, minFinapiBookingDate, maxFinapiBookingDate, minAmount, maxAmount, direction, labelIds, categoryIds, isNew, minImportDate, maxImportDate, includeSubCashFlows, order);
        return resp.getData();
    }
    ...
    private com.squareup.okhttp.Call getCategoryCall(Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public InlineResponse2008Categories getCategory(Long id) throws ApiException {
        ApiResponse<InlineResponse2008Categories> resp = getCategoryWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCategoryAsync(Long id, final ApiCallback<InlineResponse2008Categories> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call getMultipleCategoriesCall(List<Long> ids, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/api/v1/categories/{ids}".replaceAll("\\{format\\}","json")
    ...
    public InlineResponse20010 getMultipleCategories(List<Long> ids) throws ApiException {
        ApiResponse<InlineResponse20010> resp = getMultipleCategoriesWithHttpInfo(ids);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getMultipleCategoriesAsync(List<Long> ids, final ApiCallback<InlineResponse20010> callback) throws ApiException {
