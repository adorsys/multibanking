...
public class SecuritiesApi {
    ...
    private com.squareup.okhttp.Call getAndSearchAllSecuritiesCall(List<Long> ids, String search, List<Long> accountIds, Integer page, Integer perPage, List<String> order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/api/v1/securities".replaceAll("\\{format\\}","json");
     ...
     */
    public InlineResponse20017 getAndSearchAllSecurities(List<Long> ids, String search, List<Long> accountIds, Integer page, Integer perPage, List<String> order) throws ApiException {
        ApiResponse<InlineResponse20017> resp = getAndSearchAllSecuritiesWithHttpInfo(ids, search, accountIds, page, perPage, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse20017> getAndSearchAllSecuritiesWithHttpInfo(List<Long> ids, String search, List<Long> accountIds, Integer page, Integer perPage, List<String> order) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getAndSearchAllSecuritiesAsync(List<Long> ids, String search, List<Long> accountIds, Integer page, Integer perPage, List<String> order, final ApiCallback<InlineResponse20017> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call getMultipleSecuritiesCall(List<Long> ids, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/api/v1/securities/{ids}".replaceAll("\\{format\\}","json")
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse20018 getMultipleSecurities(List<Long> ids) throws ApiException {
        ApiResponse<InlineResponse20018> resp = getMultipleSecuritiesWithHttpInfo(ids);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse20018> getMultipleSecuritiesWithHttpInfo(List<Long> ids) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getMultipleSecuritiesAsync(List<Long> ids, final ApiCallback<InlineResponse20018> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call getSecurityCall(Long id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/api/v1/securities/{id}".replaceAll("\\{format\\}","json")
     ...
     * @return InlineResponse20017Securities
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse20017Securities getSecurity(Long id) throws ApiException {
        ApiResponse<InlineResponse20017Securities> resp = getSecurityWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * Get a single security for a specific user. Must pass the security&#39;s identifier and the user&#39;s access_token. &lt;p&gt;Note: Whenever a security account is being updated, its security positions will be internally re-created, meaning that the identifier of a security position might change over time.&lt;/p&gt;
     * @param id Security identifier (required)
     * @return ApiResponse&lt;InlineResponse20017Securities&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse20017Securities> getSecurityWithHttpInfo(Long id) throws ApiException {
        com.squareup.okhttp.Call call = getSecurityValidateBeforeCall(id, null, null);
        Type localVarReturnType = new TypeToken<InlineResponse20017Securities>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getSecurityAsync(Long id, final ApiCallback<InlineResponse20017Securities> callback) throws ApiException {
