...
public class MocksAndTestsApi {
     ...
     */
    public com.squareup.okhttp.Call checkCategorizationCall(CheckCategorizationData body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call checkCategorizationValidateBeforeCall(CheckCategorizationData body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public CategorizationCheckResults checkCategorization(CheckCategorizationData body) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<CategorizationCheckResults> checkCategorizationWithHttpInfo(CheckCategorizationData body) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call checkCategorizationAsync(CheckCategorizationData body, final ApiCallback<CategorizationCheckResults> callback) throws ApiException {
