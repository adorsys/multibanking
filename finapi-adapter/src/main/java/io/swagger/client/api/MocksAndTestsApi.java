...
public class MocksAndTestsApi {
    ...
    private com.squareup.okhttp.Call mockBatchUpdateCall(Body12 body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/api/v1/tests/mockBatchUpdate".replaceAll("\\{format\\}","json");
    ...
    private com.squareup.okhttp.Call mockBatchUpdateValidateBeforeCall(Body12 body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public void mockBatchUpdate(Body12 body) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> mockBatchUpdateWithHttpInfo(Body12 body) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call mockBatchUpdateAsync(Body12 body, final ApiCallback<Void> callback) throws ApiException {
