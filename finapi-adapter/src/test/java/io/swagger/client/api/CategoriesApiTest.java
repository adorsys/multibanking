...
public class CategoriesApiTest {
     ...
     */
    @Test
    public void editCategoryTest() throws ApiException {
        Long id = null;
        EditCategoryParams body = null;
        Category response = api.editCategory(id, body);
    ...
    public void getCashFlowsTest() throws ApiException {
        ...
        List<String> order = null;
        CashFlowList response = api.getCashFlows(search, counterpart, purpose, accountIds, minBankBookingDate, maxBankBookingDate, minFinapiBookingDate, maxFinapiBookingDate, minAmount, maxAmount, direction, labelIds, categoryIds, isNew, minImportDate, maxImportDate, includeSubCashFlows, order);
    ...
    public void trainCategorizationTest() throws ApiException {
        TrainCategorizationData body = null;
