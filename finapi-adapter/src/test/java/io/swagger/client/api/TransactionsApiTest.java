...
public class TransactionsApiTest {
    ...
    public void deleteAllTransactionsTest() throws ApiException {
        ...
        Boolean safeMode = null;
        Boolean rememberDeletion = null;
        IdentifierList response = api.deleteAllTransactions(maxDeletionDate, safeMode, rememberDeletion);
    ...
    public void getAndSearchAllTransactionsTest() throws ApiException {
        ...
        PageableTransactionList response = api.getAndSearchAllTransactions(view, ids, search, counterpart, purpose, accountIds, minBankBookingDate, maxBankBookingDate, minFinapiBookingDate, maxFinapiBookingDate, minAmount, maxAmount, direction, labelIds, categoryIds, includeChildCategories, isNew, isPotentialDuplicate, isAdjustingEntry, minImportDate, maxImportDate, page, perPage, order);
