...
public class WebPull {
    ...
    public static ArrayList getTransData(WebClient syncWebClient, String Kontonummer, String creditCardNumber, String fromDateSimple, String toDateSimple, HtmlPage activePage) throws Exception {
    ...
    private static ArrayList parseCSV(String kontonummer, String fromDateSimple, String toDateSimple, String csvResponse) throws Exception {
        ...
        if (!csvResponse.contains("<html") && !csvResponse.contains("<head")) {
            ...
            for (int i = 0; i < csvdatarow.length; ++i) {
                if (csvdatarow[i].length > 0 && csvdatarow[i][0].equals("Saldo:")) {
                    ...
                    if (StringUtils.isBlank(csvdatarow[i][1])) {
                        throw new Exception("Guthaben von der Deutsche Kreditbank AG (DKB) nicht angegeben! Fehlt im Kontoauszug");
                    }

                    amount = Double.parseDouble(de.adorsys.onlinebanking.web.StringUtils.shrinkString(csvdatarow[i][1]).replaceAll("&nbsp;", "").replaceAll(" ", "").replaceAll("€", "").replaceAll("EUR", "").replaceAll("&euro;", "").replaceAll("\\+", "").replaceAll("\\s", "").trim());
            ...
            if (!foundAmount) {
                throw new Exception("Guthaben von der Deutsche Kreditbank AG (DKB) nicht gefunden! (Bitte dem Entwickler im Forum melden)");
            } else {
                ...
                for (int i = 0; i < matrixArrayData.length; ++i) {
                    if (matrixArrayData[i] != null && !StringUtils.isBlank(matrixArrayData[i][0])) {
                        LOG.trace("matrixArrayData: Zeile Nr. " + i + " wurde beachtet da diese nicht leer ist ... und wird nun auf eine Umsatzzeile gepürft ...");
                        if ((csvdatarow[i][0].equals("Ja") || csvdatarow[i][0].equals("Nein")) && !StringUtils.isBlank(csvdatarow[i][1]) && !StringUtils.isBlank(csvdatarow[i][2])) {
                            try {
                                ...
                                LOG.trace("transactionDataList[" + arrayRowCount + "][0]  hat nun folgenden Inhalt: (Datum)               : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(0));
                                ...
                                LOG.trace("transactionDataList[" + arrayRowCount + "][1]  hat nun folgenden Inhalt: (Valuta)              : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(1));
                                double Betrag = Double.parseDouble(de.adorsys.onlinebanking.web.StringUtils.shrinkString(matrixArrayData[i][4]).replaceAll("\\.", "").replaceAll(",", ".").replaceAll("&nbsp;", "").replaceAll(" ", "").replaceAll("€", "").replaceAll("&euro;", "").replaceAll("EUR", "").replaceAll("\\+", "").replaceAll("\\s", "").trim());
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(Betrag);
                                LOG.trace("transactionDataList[" + arrayRowCount + "][2]  hat nun folgenden Inhalt: (Betrag)              : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(2));
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(Double.parseDouble("0"));
                                LOG.trace("transactionDataList[" + arrayRowCount + "][3]  hat nun folgenden Inhalt: (Saldo)               : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(3));
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(new String("EUR"));
                                LOG.trace("transactionDataList[" + arrayRowCount + "][4]  hat nun folgenden Inhalt: (Währung)             : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(4));
                                ...
                                LOG.trace("transactionDataList[" + arrayRowCount + "][5]  hat nun folgenden Inhalt: (Umsatzart)           : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(5));
                                ...
                                LOG.trace("transactionDataList[" + arrayRowCount + "][6]  hat nun folgenden Inhalt: (Verwendungszweck)    : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(6));
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(new String());
                                LOG.trace("transactionDataList[" + arrayRowCount + "][7]  hat nun folgenden Inhalt: (IBAN)                : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(7));
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(new String());
                                LOG.trace("transactionDataList[" + arrayRowCount + "][8]  hat nun folgenden Inhalt: (BIC)                 : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(8));
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(new String());
                                LOG.trace("transactionDataList[" + arrayRowCount + "][9]  hat nun folgenden Inhalt: (Gegenkonto-Name)     : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(9));
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(new String());
                                LOG.trace("transactionDataList[" + arrayRowCount + "][10] hat nun folgenden Inhalt: (Gegenkonto-Nummer)   : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(10));
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(new String());
                                LOG.trace("transactionDataList[" + arrayRowCount + "][11] hat nun folgenden Inhalt: (Gegenkonto-BLZ)      : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(11));
                                if (!StringUtils.isBlank(matrixArrayData[i][5])) {
                                    ((ArrayList) transactionDataList.get(arrayRowCount)).add("Ursprünglicher Betrag: " + matrixArrayData[i][5]);
                                } else {
                                    ((ArrayList) transactionDataList.get(arrayRowCount)).add(new String());
                                }

                                LOG.trace("transactionDataList[" + arrayRowCount + "][12] hat nun folgenden Inhalt: (Kommentar)           : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(12));
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(new String());
                                LOG.trace("transactionDataList[" + arrayRowCount + "][13] hat nun folgenden Inhalt: (Primanotakennzeichen): " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(13));
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(new String());
                                LOG.trace("transactionDataList[" + arrayRowCount + "][14] hat nun folgenden Inhalt: (Kundenreferenz)      : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(14));
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(i + 1);
                                LOG.trace("transactionDataList[" + arrayRowCount + "][15] hat nun folgenden Inhalt: (Zeilennummer-Auszug) : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(15));
                                ((ArrayList) transactionDataList.get(arrayRowCount)).add(Boolean.FALSE);
                                LOG.trace("transactionDataList[" + arrayRowCount + "][16] hat nun folgenden Inhalt: (vorhanden? Marker)   : " + ((ArrayList) transactionDataList.get(arrayRowCount)).get(16));
                                ++arrayRowCount;
                            } catch (Exception var45) {
                                throw new Exception("Exception beim Verarbeiten/Auslesen des RAW-Kontoauszugs-Array - Log-Eintrag: " + ExceptionUtils.getStackTrace(var45));
                            }
                        }
                    }
                }
                ...
                ArrayList sortetBankArrayListAndData = StatementWorker.createBankArrayListHeader("DKB", kontonummer, amount, amount, 0.0D, fromDateSimple, toDateSimple);
    ...
    private static String goToCsvPage(WebClient syncWebClient) throws Exception {
        ...
        Page csv = syncWebClient.getPage("https://www.dkb.de/banking/finanzstatus/kreditkartenumsaetze?$event=csvExport");
    ...
    private static HtmlPage goToCreditCardPage(WebClient syncWebClient, HtmlPage ActiveContent) throws Exception {
        ...
        if (activeContentUrl.toString().indexOf("/portal") != -1) {
            ...
            creditCardPageUrl = "https://banking.dkb.de/banking" + ActiveContent.getAnchorByText("Kreditkartenumsätze").getHrefAttribute();
            ...
            if (activeContentUrl.toString().indexOf("/dkb") == -1) {
                throw new RuntimeException("Kreditkartenübersicht kann aufgrund einer unbekannten URL nicht aufgerufen werden. Bitte informieren Sie den Entwickler");
            }
    ...
    private static void selectCreditCard(HtmlPage creditCardPage, String creditCardNumber) {
        ...
        if (creditCardPageUrl.toString().indexOf("/banking") != -1) {
            ...
            if (creditCardPageUrl.toString().indexOf("/dkb") == -1) {
                throw new RuntimeException("Kreditkartenauswahl-Formular kann aufgrund einer unbekannten URL nicht gesetzt werden. Bitte informieren Sie den Entwickler");
            }
        ...
        if (!found) {
            throw new RuntimeException("Kreditkarte " + creditCardNumber + " in der Auswahl auf der Hompage nicht gefunden! Kontrollieren Sie bitte Ihre Angaben in den Konto-Einstellungen");
        }
    }
    ...
    private static DomElement findSearchButton(HtmlPage creditCardPage) {
        ...
        if (creditCardPageUrl.toString().indexOf("/banking") != -1) {
            ...
            if (searchbutton == null) {
                ...
                throw new RuntimeException("Fehler beim Setzen des Suchbutton (dieser ist NULL - Bitte den Entwickler im Forum informieren)");
            }
        } else {
            if (creditCardPageUrl.toString().indexOf("/dkb") == -1) {
                throw new RuntimeException("Kreditkartenauswahl-Formular kann aufgrund einer unbekannten URL nicht gesetzt werden. Bitte informieren Sie den Entwickler");
    ...
    private static void validateCreditCardNumber(String unterkonto) {
        ...
        if (!valid) {
            throw new IllegalArgumentException("Die übergebene Kreditkartennummer ist nicht im erforderlichen Format angegeben: 1234********5678 (ersten 4 Stellen + 8 Sternchen + letzen 4 Stellen)");
        }
    }
}
